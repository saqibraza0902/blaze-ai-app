...
import ImageGen from '../ui/icons/image-gen';
...
import VideoGen from '../ui/icons/vide-generator';
...
export const FOCUS_MODES = [
  ...
  },
  {
    ...
    des: 'Generate stunning images for branding, marketing and visual storytelling',
    icon: ImageGen,
    value: 'image_generation',
  },
  {
    Label: 'Generate Video',
    des: 'Generate stunning Videos for branding, marketing and visual storytelling',
    icon: VideoGen,
