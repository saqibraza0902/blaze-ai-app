...
// import {setConvoSettings} from '../../redux/slices/model';
...
import {
  get_conversation_setting,
  update_conversation_setting,
} from '../../utils/functions';
import {handleApiError} from '../../utils/error';
import CustomCheckbox from '../check-box';

import {Colors} from '../../constant/Colors';
import {setConvoSettings} from '../../redux/slices/conversation';
...
const IdeaHubSetting = ({id}: IProps) => {
  ...
  return (
    <View style={{paddingBottom: 60}}>
      <View>
        <Text
          style={{fontSize: 25, color: Theme_colors.text, textAlign: 'center'}}>
          I.D.E.A. Hub
        </Text>
      </View>
      ...
      <View>
        <View style={styles.Textcontainer}>
          <Text style={[styles.text, {color: Theme_colors.text}]}>
            Blaze Max (Coordinator)
          </Text>
        </View>
        <View style={[styles.line, {backgroundColor: Theme_colors.text}]} />
              ...
              <View style={{flexDirection: 'row', gap: 20}}>
                <View
                  ...
                  <CustomCheckbox
                    ...
                    onToggle={() => {
                      if (!id) {
                        dispatchSelectedModels(item);
                      } else {
                        console.log('');
                      }
                    }}
                    size={30}
                    fillColor={Theme_colors.text}
                    borderColor="#888"
                    borderWidth={2}
                  ...
                  <View>
                    <Image
                      source={
                        theme === 'light'
                          ? require('../../../assets/images/blaze/black_ai.png')
                          : require('../../../assets/images/blaze/ai.png')
                      }
                      style={{
                        width: 30,
                        height: 30,
      ...
      {id && (
        <TouchableOpacity onPress={updateConversationSetting}>
